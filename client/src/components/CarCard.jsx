...
const CarCard = ({car}) => {
  ...
  return (
    ...
    <div className='group rounded-xl overflow-hidden shadow-lg hover:-translate-y-1 transition-all duration-500 cursor-pointer'>
        ...
        <div className='relative h-48 overflow-hidden' /* parte de cima dos cards, imagem do carro e preço*/> 
            ...
            <div className='absolute bottom-4 right-4 bg-black/80 backdrop-blur-sm text-white px-3 py-2 rounded-lg' /* preço do carro em dolar usando currency_vite */>
                <span className='font-semibold'>{currency}{car.pricePerDay}</span> 
                <span className='text-sm text-white/80'> / day</span>
            </div>         
        </div>

        <div className='p-4 sm:p-5' /* criando todos os dados dos carros exemplo: marca, assentos, combustivel etc para colocar no card*/>
